...
from Imonggo.api.lib.filters import FilterSet
from Imonggo.api.lib.connection import EmptyResponseWarning

log = logging.getLogger("imonggo")
...
class ResourceAccessor(object):
    ...
    def __get_page(self, page, limit, query={}):
        ...
        _query.update(query)
        return self._connection.get("%s.xml" % self._url, _query)
